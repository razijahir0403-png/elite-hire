            ...
            <div key={c._id} className="glass-card p-6 rounded-2xl border border-slate-200/90 flex flex-col justify-between space-y-5 bg-white shadow-sm">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs pt-3 border-t border-slate-100">
                  ...
                  <div>
                    <span className="text-slate-450 block font-medium">Package</span>
                    <span className="text-slate-700 font-semibold">{c.salaryPackage}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-slate-700 font-semibold truncate block">{c.contactNumber}</span>
                  </div>
                </div>
