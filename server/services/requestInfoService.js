...
const updateRequestInfo = async (id, body, editorName) => {
  ...
  const { idnumber, domain, salaryPackage, location, contactNumber, resourcePerson, portalLink } = body;
  ...
  if (salaryPackage !== undefined) record.salaryPackage = salaryPackage;
