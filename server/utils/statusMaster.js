...
const toPaymentStatusCode = (value, fallback = PAYMENT_STATUS.PENDING) => {
  if (typeof value === 'string') {
    if (PAYMENT_TEXT_TO_CODE[value] !== undefined) return PAYMENT_TEXT_TO_CODE[value];
